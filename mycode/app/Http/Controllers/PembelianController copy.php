...
class PembelianController extends Controller
{
   ...
   public function listData()
   {
     ...
     foreach($pembelian as $list){
       ...
       $row[] = '<div class="btn-group">
               ...
               <a onclick="editData(\''.$list->id_pembelian.'\')" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i></a>
   ...
   public function create($id)
   {
      ...
      $pembelian->save();
      $idbeli=$pembelian->id_pembelian;

      // session(['idpembelian' => $pembelian->id_pembelian]);
      // session(['idsupplier' => $id]);

      //return Redirect::route('pembelian_detail.index',['id'=>$idbeli]);
      //return redirect('pembeliandetail/'.$idbeli);
      echo $idbeli;
   }
