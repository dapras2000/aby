  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        ...
        <br>--><h3>
        <span id="laporan">Laporan Pembelian <span id="tgl1">{{ tanggal_indonesia($awal, false) }}</span> s/d <span id="tgl2">{{ tanggal_indonesia($akhir, false) }}</span></span>
        </h3>
      </div>
...
$(function(){    
   table = $('#tabellaporanbeli').DataTable({     
     ...
     "serverside" : true,
     "ajax" : {
       "url" : "laporanpembelian/data/{{ $awal }}/{{ $akhir }}",
       "type" : "GET"
     },          
